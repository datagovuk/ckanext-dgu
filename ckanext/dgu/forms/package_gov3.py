...
#    builder.set_field_text('external_reference', 'Inventory identifier', instructions='The identifier for the dataset allocated by the data.gov.uk team, for tracking purposes.')
    ...
    builder.set_field_text('author', 'Contact', instructions='The permanent contact point for the public to enquire about this particular dataset', further_instructions='This should be the name of the section of the agency or Department responsible, and should not be a named person. Particular care should be taken in choosing this element.', hints='Examples: Statistics team, Public consultation unit, FOI contact point')
...
#    if statistics:
    ...
    builder.set_field_text('license_id', 'Licence', instructions='The licence under which the dataset is released.', further_instructions='For most situations of central Departments\' and Local Authority data, this should be the \'Open Government Licence\'. If you wish to release the data under a different licence, please contact the Making Public Data Public team.')
