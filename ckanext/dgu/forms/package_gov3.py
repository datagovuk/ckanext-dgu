...
#    if statistics:
    ...
    builder.set_field_text('name', 'Identifier', instructions='A public unique identifier for the dataset', further_instructions='It should be roughly readable, with dashes separating words. If the data relates to a period of time, include that in the name. Indicate broad geographical coverage to distinguish from those datasets for another country.', hints='Format: Two or more lowercase alphanumeric, dash (-) or underscore (_) characters. e.g. uk-road-traffic-statistics')
    builder.set_field_text('title', instructions='The title of the data set', further_instructions='It is not a description - save that for the Abstract element. Do not give a trailing full stop.')
    builder.set_field_text('external_reference', 'Inventory identifier', instructions='The identifier for the dataset allocated by the data.gov.uk team, for tracking purposes.')
    ...
    builder.set_field_text('precision', instructions='Indicate the level of precision in the data, to avoid over-interpretation.', hints='e.g. \'per cent to two decimal places\'')
    builder.set_field_text('geographic_granularity', instructions='The lowest level of geographic granularity given in the dataset.', further_instructions='\'Point\' means datasets given down to the level of the entities being reported on (such as school, hospital, or police station). If none of the choices is appropriate, please specify in the \'other\' element. Where the granularity varies, please select the lowest and note this in the \'other\' element. ')
    ...
    builder.set_field_text('temporal_granularity', instructions='The lowest level of temporal granularity, expressed as an interval of time, given in the dataset', further_instructions='\'Points\' means temporal intervals given down to the level of the entities being reported on (for example, reporting on coastal sea levels in tide tables; the time intervals are high and low tide, therefore the choice would be \'points\'). If none of the choices are appropriate, please specify in the \'other\' element. Where the granularity varies, please select the lowest interval.')
    builder.set_field_text('temporal_coverage', instructions='The temporal coverage of this dataset.', further_instructions='If available, please indicate the time as well as the date. Where data covers only a single day, the \'To\' sub-element can be left blank.', hints='e.g. 23:28 21/03/2007 - 07:31 03/10/2009')
    builder.set_field_text('url', instructions='The Internet link to a web page for the data.', hints='e.g. http://www.somedept.gov.uk/growth-figures.html')
    ...
    builder.set_field_text('agency', instructions='The agency or arms-length body responsible for the data collection', further_instructions='Please use the full title of the body without any abbreviations, so that all items from it appear together.', hints='e.g. Environment Agency')
    builder.set_field_text('license_id', instructions='The licence under which the dataset is released.', further_instructions='For most situations of central Departments\' and Local Authority data, this should be the \'Open Government Licence\'. If you wish to release the data under a different licence, please contact the Making Public Data Public team.')
    builder.set_field_text('publisher', instructions='Unit responsible for publishing the data', further_instructions='This value may be different from the Unit responsible for creating the data.')
    builder.set_field_text('author', 'Contact', instructions='The name of the permanent contact point for the public to enquire about this particular dataset', further_instructions='This should be the name of the section of the agency or Department responsible, and should not be a named person. Particular care should be taken in choosing this element.')
    builder.set_field_text('author_email', 'Contact email', instructions='A generic official e-mail address for members of the public to contact, to match the Author element.', further_instructions='A new e-mail address may need to be created for this function.')
#    if statistics:
    if True:
    ...
    builder.set_field_text('mandate', instructions='URI to Legislation website, e.g., to section of Act that mandates collection/creation of data.', hints='For example Public Record Act s.2 would be: http://www.legislation.gov.uk/id/ukpga/Eliz2/6-7/51/section/2')
